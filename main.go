...
func extractPDFUrls(htmlContent string) []string {
	// Regex pattern to capture anything ending in .pdf (with optional query params after it)
	regexPattern := `(https?://[^\s"']+\.pdf(?:\?[^\s"']*)?|/[^\s"']+\.pdf(?:\?[^\s"']*)?)`
	...
	// Find all matches of the regex in the given string
	allMatches := compiledRegex.FindAllString(htmlContent, -1)
...
func main() {
	...
	remoteURL := []string{
		"https://www.berkebileoil.com/safety-data-sheets.html",
		"https://www.berkebileoil.com/product-literature.html",
		"https://www.berkebileoil.com/pfc-literature.html",
		"http://www.berkebileoil.com/air-line-anti-freeze1.html",
		"https://www.berkebileoil.com/gas-line-anti-freeze.html",
		"https://www.berkebileoil.com/isopropyl-gas-line-anti-freeze.html",
		"https://www.berkebileoil.com/fuel-stor.html",
		"https://www.berkebileoil.com/bio-fuel-treatment.html",
		"https://www.berkebileoil.com/gas-treatment.html",
		"https://www.berkebileoil.com/fuel-injector-cleaner.html",
		"https://www.berkebileoil.com/lead-substitute.html",
		"https://www.berkebileoil.com/transmission-stop-leak.html",
		"https://www.berkebileoil.com/super-oil-treatment.html",
		"https://www.berkebileoil.com/diesel-fuel-conditioner.html",
		"https://www.berkebileoil.com/diesel-cleaner-booster.html",
		"https://www.berkebileoil.com/diesel-defrost.html",
		"https://www.berkebileoil.com/friction-modifier-additive.html",
		"https://www.berkebileoil.com/rubberized-undercoat.html",
		"https://www.berkebileoil.com/protector-beautifier.html",
		"https://www.berkebileoil.com/instant-gum-cutter.html",
		"https://www.berkebileoil.com/electric-contact-plugs-and-points-cleaner.html",
		"https://www.berkebileoil.com/fuel-injector-cleaner.html",
		"https://www.berkebileoil.com/mineral-spirits-and-solvents.html",
		"https://www.berkebileoil.com/radiator-super-flush-concentrate.html",
		"https://www.berkebileoil.com/radiator-stop-leak.html",
		"https://www.berkebileoil.com/brake-fluid---dot-3.html",
		"https://www.berkebileoil.com/brake-fluid---dot-4.html",
		"https://www.berkebileoil.com/windshield-washer-concentrate.html",
		"https://www.berkebileoil.com/power-steering-fluid.html",
		"https://www.berkebileoil.com/universal-power-steering-fluid.html",
		"https://www.berkebileoil.com/dm-multi-purpose-atf.html",
		"https://www.berkebileoil.com/atf-v-multi-purpose-atf.html",
		"https://www.berkebileoil.com/pen-lube-with-ptfe.html",
		"https://www.berkebileoil.com/red-grease.html",
		"https://www.berkebileoil.com/spray-silicone-lubricant.html",
		"https://www.berkebileoil.com/rubberized-undercoat.html",
	}
